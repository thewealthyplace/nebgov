...
This directory contains the Architecture Decision Records (ADRs) for NebGov.

ADRs document significant design decisions, the context behind them, alternatives considered, and consequences.

## Index

| ADR | Title | Status |
|-----|-------|--------|
| [ADR-001](./adr-001-checkpoint-voting-power.md) | Checkpoint-based voting power | Accepted |
| [ADR-002](./adr-002-no-admin-role.md) | No admin/owner role | Accepted |
| [ADR-003](./adr-003-separate-timelock.md) | Timelock as a separate contract | Accepted |
